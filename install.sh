...
# --- install toolchain
sudo apt-get install -y "clang-${LLVM_VER}" "clang++-${LLVM_VER}" "lld-${LLVM_VER}" "llvm-${LLVM_VER}" "lldb-${LLVM_VER}"
...
sudo update-alternatives --install /usr/bin/lldb-dap lldb-dap "/usr/bin/lldb-dap-${LLVM_VER}" 100
...
sudo update-alternatives --set lldb-dap "/usr/bin/lldb-dap-${LLVM_VER}"
