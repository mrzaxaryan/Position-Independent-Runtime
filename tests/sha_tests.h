...
private:
	...
	static BOOL TestSHA224_Empty()
	{
		...
		constexpr UINT8 expected_data[SHA224_DIGEST_SIZE] = {
	...
	static BOOL TestSHA256_Empty()
	{
		...
		constexpr UINT8 expected_data[SHA256_DIGEST_SIZE] = {
	...
	static BOOL TestSHA384_Empty()
	{
		...
		constexpr UINT8 expected_data[SHA384_DIGEST_SIZE] = {
	...
	static BOOL TestSHA512_Empty()
	{
		...
		constexpr UINT8 expected_data[SHA512_DIGEST_SIZE] = {
