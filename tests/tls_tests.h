...
// Test Server: 0y.wtf (79.133.51.99:8443)
// Protocol: TCP+TLS 1.3 Echo Server
// =============================================================================
...
private:
	...
	static constexpr UINT16 TLS_PORT = 8443;             // TCP+TLS Echo Server
...
public:
	...
	static BOOL RunAll()
	{
		...
		LOG_INFO("Test Server: 0y.wtf (79.133.51.99:8443)");
