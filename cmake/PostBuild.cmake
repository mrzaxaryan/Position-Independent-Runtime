...
function(pir_add_postbuild target_name)
    ...
    # Remove PT_PHDR (Solaris kernel rejects static binaries with PT_PHDR
    # but no PT_INTERP — LLD always emits PT_PHDR with no way to suppress it)
    set(_phdr_cmd)
    if(PIR_PLATFORM STREQUAL "solaris")
        set(_phdr_cmd
            COMMAND ${CMAKE_COMMAND}
                -DELF_FILE="${_out}${PIR_EXT}"
                -P "${PIR_ROOT_DIR}/cmake/scripts/RemovePhdr.cmake"
        )
    endif()
